...
<Callout type="info">
**Smart dependencies:** The CLI automatically installs required modules if they're missing. Running `zuro add auth` will also set up database, validator, and error-handler for you!
</Callout>
