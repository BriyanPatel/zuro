...
Because auth is configured with the Better Auth `openAPI` plugin, you can inspect available auth endpoints in your browser:

```text
http://localhost:3000/api/auth/reference
```

This is useful for quickly checking request/response shapes while building.
