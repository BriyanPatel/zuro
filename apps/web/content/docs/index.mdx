---
title: Introduction
seoTitle: Zuro Documentation - Express TypeScript Backend Setup
description: 'Zuro documentation: learn how to initialize an Express TypeScript backend, then add auth, database, uploads, validation, and API docs modules.'
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
  ...
  <a href="/docs/uploads" className="block border border-border rounded-xl p-5 bg-card hover:border-green-500/50 transition-colors no-underline">
    ...
    <p className="text-sm text-muted-foreground">S3, R2, or Cloudinary upload flows</p>
  </a>
  ...
  <a href="/docs/docs" className="block border border-border rounded-xl p-5 bg-card hover:border-green-500/50 transition-colors no-underline">
    <h3 className="font-bold text-foreground mb-1">→ Add API Docs</h3>
    <p className="text-sm text-muted-foreground">Document uploads, auth, and your own routes</p>
  </a>
</div>
